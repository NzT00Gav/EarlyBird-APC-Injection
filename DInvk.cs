...
namespace Runtime.Ivk
{
    public class DELEGATE
    {
        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        public delegate void RtlInitUnicodeString(ref STRUCTURE.UNICODE_STRING DestinationString, [MarshalAs(UnmanagedType.LPWStr)] string SourceString);
    }
    ...
    public class Gen
    {
        ...
        public static STRUCTURE.NTSTATUS LdrLoadDll(IntPtr PathToFile, UInt32 dwFlags, ref STRUCTURE.UNICODE_STRING ModuleFileName, ref IntPtr ModuleHandle)
        {
            ...
            STRUCTURE.NTSTATUS retValue = (STRUCTURE.NTSTATUS)DyAPIivk(@"ntdll.dll", @"LdrLoadDll", typeof(DELEGATE.RtlInitUnicodeString), ref funcargs);
        ...
        public static void RtlInitUnicodeString(ref STRUCTURE.UNICODE_STRING DestinationString, [MarshalAs(UnmanagedType.LPWStr)] string SourceString)
        {
            // Craft an array for the arguments
            object[] funcargs =
            {
            ...
            DyAPIivk(@"ntdll.dll", @"RtlInitUnicodeString", typeof(DELEGATE.RtlInitUnicodeString), ref funcargs);

            // Update the modified variables
            DestinationString = (STRUCTURE.UNICODE_STRING)funcargs[0];
        }
        ...
        public static object DyAPIivk(string DLLName, string FunctionName, Type FunctionDelegateType, ref object[] Parameters)
        {
            IntPtr pFunction = GetLibAddrs(DLLName, FunctionName);
            return DyFuncIvk(pFunction, FunctionDelegateType, ref Parameters);
        }
        ...
        /// <returns>Object returned by the function. Must be unmarshalled by the caller.</returns>
        public static object DyFuncIvk(IntPtr FunctionPointer, Type FunctionDelegateType, ref object[] Parameters)
        {
        ...
        {
            STRUCTURE.UNICODE_STRING uModuleName = new STRUCTURE.UNICODE_STRING();
            RtlInitUnicodeString(ref uModuleName, DLLPath);

            IntPtr hModule = IntPtr.Zero;
            STRUCTURE.NTSTATUS CallResult = LdrLoadDll(IntPtr.Zero, 0, ref uModuleName, ref hModule);
            if (CallResult != STRUCTURE.NTSTATUS.Success || hModule == IntPtr.Zero)
            {
                return IntPtr.Zero;
            }
        ...
        public static IntPtr GetLoadedModAddrs(string DLLName)
        {
        ...
        public static IntPtr GetLibAddrs(string DLLName, string FunctionName, bool CanLoadFromDisk = false)
        {
            IntPtr hModule = GetLoadedModAddrs(DLLName);
            ...
            return GetExportAddrs(hModule, FunctionName);
        }
        ...
        /// <returns>IntPtr for the desired function.</returns>
        public static IntPtr GetExportAddrs(IntPtr ModuleBase, string ExportName)
        {
